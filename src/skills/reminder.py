...
from src.core.voice_assistant import assistant

class Reminder:
    def __init__(self):
        pass
    
    def create_reminder_in_app(self, reminder_text, reminder_datetime):
    ...
    def set_reminder(self):
        ...
        try:
            ...
            self.create_reminder_in_app(reminder, reminder_datetime)
